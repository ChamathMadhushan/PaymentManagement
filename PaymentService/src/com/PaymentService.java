...
public class PaymentService extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String output = payObj.insertPayment(request.getParameter("cardNo"), request.getParameter("nameOnCard"),
				request.getParameter("expDate"), request.getParameter("cvc"));
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response)
		...
		String output = payObj.deletePayment(paras.get("itemID").toString());
